...
# TODO Show in a graph the relationship between air_time, distance and origin

ggplot(flights) +
  geom_point(aes(distance, air_time, color = origin))

# TODO Show in a graph the relationship between air_time, distance and dep_delay
